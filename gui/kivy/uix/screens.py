...
from electrum_zcl.util import profiler, parse_URI, format_time, InvalidPassword, NotEnoughFunds
from electrum_zcl import bitcoin
from electrum_zcl.util import timestamp_to_datetime
...
class SendScreen(CScreen):
    ...
    def do_save(self):
        ...
        from electrum_zcl.paymentrequest import make_unsigned_request, PaymentRequest
...
class ReceiveScreen(CScreen):
    ...
    def get_URI(self):
        from electrum_zcl.util import create_URI
