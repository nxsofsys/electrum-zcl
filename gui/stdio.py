...
from electrum_zcl.util import format_satoshis, set_verbosity
from electrum_zcl.bitcoin import is_valid, COIN, TYPE_ADDRESS
from electrum_zcl.network import filter_protocol
...
class ElectrumGui:
    ...
    def __init__(self, config, daemon, plugins):
        ...
        if not storage.file_exists:
            print "Wallet not found. try 'electrum-zcl create'"
            exit()
    ...
    def network_dialog(self):
        print("use 'electrum-zcl setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-zcl setconfig' to change your settings")
        return True
